		...
		<>
			...
			<div className="min-h-screen overflow-y-hidden">
				{context.cart.length > 0 ? (
					<div className="mt-28">
						...
						<div className="flex px-8 space-x-8 items-start mt-20">
							...
							<div className="mt-[32px] border border-neutral-200 flex flex-col space-y-4 p-4 w-1/4">
								...
								<div>
									<button className="bg-blue-900 hover:bg-blue-600 text-white w-full py-2 rounded-md">
										Checkout
									</button>
								</div>
							</div>
					...
					<div className="mt-60 flex flex-col items-center space-y-6">
						<h1 className="text-2xl font-bold text-blue-900">
							Your Shopping Cart is Empty
						</h1>
						<Link
							href="/watches"
							className="bg-blue-900 hover:bg-blue-600 rounded-md text-white text-center px-8 py-2 font-semibold"
						>
							Continue Shopping
						</Link>
					</div>
